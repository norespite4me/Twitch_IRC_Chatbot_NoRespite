...
function automod(user, cmd, args, channel, client, permitted, time) {
    ...
    var botspam_buysubs = phrase.match(/ *b *u *y( *f *o *l *l *o *w| *s *u *b| *v *i *e *w| *p *r *i *m *e)(.+?( *f *o *l *l *o *w| *s *u *b| *v *i *e *w| *p *r *i *m *e))*.+?( *b *i *g *f *o *l *l *o *w *s)?/gi);
    console.log(phrase, matches, botspam_buysubs);
